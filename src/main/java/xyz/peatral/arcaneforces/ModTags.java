...
public class ModTags {
    ...
    public static class Blocks {
        ...
        public static final TagKey<Block> INCENSE_TRAVEL_STARTERS = BlockTags.create(ResourceLocation.fromNamespaceAndPath(Main.MOD_ID, "incense_travel_starters"));
    }
    ...
    public static class Items {
        ...
        public static final TagKey<Item> OFFERINGS = ItemTags.create(ResourceLocation.fromNamespaceAndPath(Main.MOD_ID, "offerings"));
    }
}
